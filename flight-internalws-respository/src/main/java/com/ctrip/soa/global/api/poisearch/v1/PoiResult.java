...
public class PoiResult  {
    ...
    @FieldDoc("整体排序")
    @JsonProperty("OverallIndex")
    @XmlElement(name = "OverallIndex")
    ...
    public void setOverallIndex(int overallIndex) {
        this.overallIndex = overallIndex;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return
            ...
            Objects.equal(this.childCount, other.childCount) && 
            Objects.equal(this.overallIndex, other.overallIndex);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.childCount);
        result = 31 * result + Objects.hashCode(this.overallIndex);
