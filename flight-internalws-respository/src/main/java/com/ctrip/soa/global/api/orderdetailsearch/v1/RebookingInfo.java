...
public class RebookingInfo  {
    ...
    public RebookingInfo(
        ...
        this.isChosenNewFlight = isChosenNewFlight;
    }
    ...
    @FieldDoc("是否选了要改签的新航班")
    @JsonProperty("IsChosenNewFlight")
    @XmlElement(name = "IsChosenNewFlight")
     ...
     * 是否选了要改签的新航班
     */
    public boolean getIsChosenNewFlight() {
        return this.isChosenNewFlight;
    }

    public void setIsChosenNewFlight(boolean isChosenNewFlight) {
        this.isChosenNewFlight = isChosenNewFlight;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return
            ...
            Objects.equal(this.isChosenNewFlight, other.isChosenNewFlight);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.isChosenNewFlight);
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
            ...
            .add("isChosenNewFlight", isChosenNewFlight)
            .toString();
    }
}