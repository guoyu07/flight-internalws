...
public class PolicyPirceInfo  {
    ...
    @FieldDoc("是否包含免费优惠券")
    @JsonProperty("HasFreeCoupon")
    @XmlElement(name = "HasFreeCoupon")
    ...
    public boolean equals(Object obj) {
        ...
        return
            ...
            Objects.equal(this.hasFreeCoupon, other.hasFreeCoupon);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.hasFreeCoupon);
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
            ...
            .add("hasFreeCoupon", hasFreeCoupon)
            .toString();
    }
}