...
public class AirLineInfo  {
    ...
    @FieldDoc("归属航司联盟")
    @JsonProperty("BelongToAlliance")
    @XmlElement(name = "BelongToAlliance")
    ...
    public boolean equals(Object obj) {
        ...
        return
            ...
            Objects.equal(this.belongToAlliance, other.belongToAlliance);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.belongToAlliance);
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
            ...
            .add("belongToAlliance", belongToAlliance)
            .toString();
    }
}